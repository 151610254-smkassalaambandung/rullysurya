    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Ngubah Sandi</div>

               <form class="form-horizontal" role="form" methode="POST" action="{{ url('/Password/reset') }}">
                </form>
                ...
                <div class="col-md-6 col-md-offset-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-btn fa-refresh"></i> Ngubah sandi
                    </button>
                    </div>
                    </div>
